...
public class ContainerWithMostWater11 {
    ...
    private static int TwoPointerSolution() {
        int[] height = {1,1};
        int n = height.length;
        int l = 0, r = n-1;
        int max_container = Integer.MIN_VALUE;
        while(l < r){
            int curr_container = Math.min(height[l], height[r]) * (r-l);
            max_container = Math.max(curr_container, max_container);
